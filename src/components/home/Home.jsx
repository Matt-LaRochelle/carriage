    ...
    return (
        <div className={styles.container}>
            ...
            <div className={styles.sale}>
                <p className={styles.sale_content}>Join Brandywine Carriage Tours as our beautiful team of Belgian Draft horses take you on a relaxing tour of the Brandywine, MD countryside. You’ll get to enjoy nature, relax, and learn as we teach you about this unique historic farming community and the Legacy Wine Trail! </p>
