    ...
    return (
        <div>
            ...
            <div className={styles.tan}>
                <p>Jonathan and Shoshana brainstormed the idea to use her experience of driving for a carriage company while they were stationed at his last active duty assignment for the United States Army to bring a fun and unique experience to their new community.</p>
            ...
            <div className={styles.green}>
                <p>To that end, they were inspired to share their love of horses and fine wines by offering carriage tours through participating vineyards of the Legacy Wine Trail, and around the scenic countryside of Brandywine. </p>
                <img className={styles.image_2} src="https://images.squarespace-cdn.com/content/v1/600dd33c276d9d4dbba3cc19/1612385244623-MZM95K082W3VROOR5PL9/jon+and+shosh+birthday.jpg?format=1500w" />
            </div>
        </div>
    );
}
