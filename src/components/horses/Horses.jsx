    ...
    return (
        <div>
            ...
            <div className={styles.tan}>
                ...
                <p className={styles.icons}><a href="https://www.facebook.com/brandywinecarriagetours"><i class="fa-brands fa-facebook"></i></a><a href="https://www.instagram.com/brandywinecarriagetours/"><i class="fa-brands fa-instagram"></i></a></p>
            </div>
        </div>
    );
}
